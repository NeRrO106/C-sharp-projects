...
namespace DatingApp
{
    class Program
    {
        ...
        {
            Profile sam = new Profile("Sam Drakkila", 17);
            string[] hobbie = { "listening to audiobooks and podcasts", "playing rec sports like bowling and kickball", "writing a speculative fiction novel", "reading advice columns" };
            sam.changeHobbies(hobbie);
            Console.WriteLine(sam.ViewProfile());
            sam.changeAge(18);
            Console.WriteLine(sam.ViewProfile());
            sam.changeName("Drakkila Sam");
            sam.changeCity("New York");
            sam.changeCountry("USA");
            sam.changePronouns("he/him");
            Console.WriteLine(sam.ViewProfile());
        }
    }
}
